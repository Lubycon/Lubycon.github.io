...
;// CONCATENATED MODULE: ./node_modules/@lubycon/logger/node_modules/tslib/tslib.es6.js
/*! *****************************************************************************
...
var index_esm = __webpack_require__(6983);
...
var util_dist_index_esm = __webpack_require__(8448);
;// CONCATENATED MODULE: ./node_modules/idb/lib/idb.mjs
...
;// CONCATENATED MODULE: ./node_modules/@lubycon/logger/node_modules/@firebase/installations/dist/index.esm.js
...
var ERROR_DESCRIPTION_MAP = (_a = {},
    ...
    _a);
var ERROR_FACTORY = new util_dist_index_esm/* ErrorFactory */.LL(SERVICE, SERVICE_NAME, ERROR_DESCRIPTION_MAP);
/** Returns true if error is a FirebaseError that is based on an error from the server. */
function isServerError(error) {
    return (error instanceof util_dist_index_esm/* FirebaseError */.ZR &&
...
function registerInstallations(instance) {
    ...
    instance.INTERNAL.registerComponent(new dist_index_esm/* Component */.wA(installationsName, function (container) {
...
;// CONCATENATED MODULE: ./node_modules/@lubycon/logger/node_modules/@firebase/analytics/dist/index.esm.js
 ...
 * limitations under the License.
 */
var logger = new logger_dist_index_esm/* Logger */.Yd('@firebase/analytics');
...
var ERRORS = (index_esm_a = {},
    ...
    index_esm_a);
var index_esm_ERROR_FACTORY = new util_dist_index_esm/* ErrorFactory */.LL('analytics', 'Analytics', ERRORS);
            ...
            switch (_b.label) {
                ...
                case 6:
                    ...
                    backoffMillis = Number(e_2.customData.httpStatus) === 503
                        ? (0,util_dist_index_esm/* calculateBackoffMillis */.$s)(backoffCount, retryData.intervalMillis, LONG_RETRY_FACTOR)
                        : (0,util_dist_index_esm/* calculateBackoffMillis */.$s)(backoffCount, retryData.intervalMillis);
                    throttleMetadata = {
...
function isRetriableError(e) {
    if (!(e instanceof util_dist_index_esm/* FirebaseError */.ZR) || !e.customData) {
        return false;
    }
...
function validateIndexedDB() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!(0,util_dist_index_esm/* isIndexedDBAvailable */.hl)()) return [3 /*break*/, 1];
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0,util_dist_index_esm/* validateIndexedDBOpenable */.eu)()];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
...
function warnOnBrowserContextMismatch() {
    ...
    if ((0,util_dist_index_esm/* isBrowserExtension */.ru)()) {
        mismatchedEnvMessages.push('This is a browser extension environment.');
    }
    if (!(0,util_dist_index_esm/* areCookiesEnabled */.zI)()) {
...
function registerAnalytics(instance) {
    instance.INTERNAL.registerComponent(new dist_index_esm/* Component */.wA(ANALYTICS_TYPE, function (container) {
    ...
    instance.INTERNAL.registerComponent(new dist_index_esm/* Component */.wA('analytics-internal', internalFactory, "PRIVATE" /* PRIVATE */));
...
registerAnalytics(index_esm/* default */.Z);
/**
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(0,util_dist_index_esm/* isIndexedDBAvailable */.hl)()) {
                        return [2 /*return*/, false];
                    }
                    _a.label = 1;
                case 1:

...
__webpack_require__.d(__webpack_exports__, {
  "Z": () => (/* binding */ app_dist_index_esm)
});

// UNUSED EXPORTS: firebase

;// CONCATENATED MODULE: ./node_modules/@firebase/app/node_modules/tslib/tslib.es6.js
/*! *****************************************************************************
...
var index_esm = __webpack_require__(8448);
// EXTERNAL MODULE: ./node_modules/@firebase/component/dist/index.esm.js + 1 modules
var dist_index_esm = __webpack_require__(8886);
...
var ERRORS = (_a$1 = {},
    ...
    _a$1);
var ERROR_FACTORY = new index_esm/* ErrorFactory */.LL('app', 'Firebase', ERRORS);
 ...
 * limitations under the License.
 */
var logger = new logger_dist_index_esm/* Logger */.Yd('@firebase/app');
...
var FirebaseAppImpl = /** @class */ (function () {
    function FirebaseAppImpl(options, config, firebase_) {
        ...
        this.options_ = (0,index_esm/* deepCopy */.p$)(options);
        this.container = new dist_index_esm/* ComponentContainer */.H0(config.name);
        // add itself to container
        this._addComponent(new dist_index_esm/* Component */.wA('app', function () { return _this; }, "PUBLIC" /* PUBLIC */));
...
function createFirebaseNamespaceCore(firebaseAppImpl) {
    ...
    var namespace = {
        ...
        setLogLevel: logger_dist_index_esm/* setLogLevel */.Ub,
        onLog: onLog,
        // @ts-ignore
        apps: null,
        SDK_VERSION: version,
    ...
    function app(name) {
        ...
        if (!(0,index_esm/* contains */.r3)(apps, name)) {
    ...
    function registerComponent(component) {
        ...
        if (component.type === "PUBLIC" /* PUBLIC */) {
            ...
            if (component.serviceProps !== undefined) {
                (0,index_esm/* deepExtend */.ZB)(serviceNamespace, component.serviceProps);
            }
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    function registerVersion(libraryKeyOrName, version, variant) {
        ...
        registerComponent(new dist_index_esm/* Component */.wA(library + "-version", function () { return ({ library: library, version: version }); }, "VERSION" /* VERSION */));
    }
    function onLog(logCallback, options) {
        if (logCallback !== null && typeof logCallback !== 'function') {
            throw ERROR_FACTORY.create("invalid-log-argument" /* INVALID_LOG_ARGUMENT */);
        }
        (0,logger_dist_index_esm/* setUserLogHandler */.Am)(logCallback, options);
    }
...
function createFirebaseNamespace() {
    ...
    namespace.INTERNAL = __assign(__assign({}, namespace.INTERNAL), { createFirebaseNamespace: createFirebaseNamespace,
        ...
        createSubscribe: index_esm/* createSubscribe */.ne,
        ErrorFactory: index_esm/* ErrorFactory */.LL,
        deepExtend: index_esm/* deepExtend */.ZB });
    /**
    ...
    function extendNamespace(props) {
        (0,index_esm/* deepExtend */.ZB)(namespace, props);
    }
    return namespace;
}
...
function registerCoreComponents(firebase, variant) {
    firebase.INTERNAL.registerComponent(new dist_index_esm/* Component */.wA('platform-logger', function (container) { return new PlatformLoggerService(container); }, "PRIVATE" /* PRIVATE */));
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
if ((0,index_esm/* isBrowser */.jU)() && self.firebase !== undefined) {
...
/* harmony default export */ const app_dist_index_esm = (firebase);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "wA": () => (/* binding */ Component),
  "H0": () => (/* binding */ ComponentContainer)
});

// UNUSED EXPORTS: Provider

;// CONCATENATED MODULE: ./node_modules/@firebase/component/node_modules/tslib/tslib.es6.js
/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
...
var Provider = /** @class */ (function () {
    ...
    Provider.prototype.get = function (identifier) {
        ...
        if (!this.instancesDeferred.has(normalizedIdentifier)) {
            var deferred = new index_esm/* Deferred */.BH();
...
__webpack_require__.d(__webpack_exports__, {
  "BH": () => (/* binding */ Deferred),
  "LL": () => (/* binding */ ErrorFactory),
  "ZR": () => (/* binding */ FirebaseError),
  "zI": () => (/* binding */ areCookiesEnabled),
  "$s": () => (/* binding */ calculateBackoffMillis),
  "r3": () => (/* binding */ contains),
  "ne": () => (/* binding */ createSubscribe),
  "p$": () => (/* binding */ deepCopy),
  "ZB": () => (/* binding */ deepExtend),
  "jU": () => (/* binding */ isBrowser),
  "ru": () => (/* binding */ isBrowserExtension),
  "hl": () => (/* binding */ isIndexedDBAvailable),
  "UG": () => (/* binding */ isNode),
  "eu": () => (/* binding */ validateIndexedDBOpenable)
});

// UNUSED EXPORTS: CONSTANTS, MAX_VALUE_MILLIS, RANDOM_FACTOR, Sha1, assert, assertionError, async, base64, base64Decode, base64Encode, base64urlEncodeWithoutPadding, createMockUserToken, decode, deepEqual, errorPrefix, extractQuerystring, getGlobal, getModularInstance, getUA, isAdmin, isElectron, isEmpty, isIE, isMobileCordova, isNodeSdk, isReactNative, isSafari, isUWP, isValidFormat, isValidTimestamp, issuedAtTime, jsonEval, map, ordinal, querystring, querystringDecode, safeGet, stringLength, stringToByteArray, stringify, validateArgCount, validateCallback, validateContextObject, validateNamespace

;// CONCATENATED MODULE: ./node_modules/@firebase/util/node_modules/tslib/tslib.es6.js
/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
